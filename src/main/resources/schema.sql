...
CREATE TABLE Users(
    ...
    roleType ENUM('USER', 'ADMIN', 'MANAGER') NOT NULL
);
...
CREATE TABLE Cards(
    ...
    typeId ENUM('CREATURE', 'LAND', 'ENCHANTMENT', 'PLANEWALKER', 'SORCERY', 'INSTANT', 'ARTIFACT', 'TRIBAL') NOT NULL,
    image LONGBLOB,
    rarity ENUM('RARE', 'UNCOMMON', 'COMMON', 'LEGENDARY')
);
